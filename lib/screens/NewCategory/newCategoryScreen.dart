...
import 'package:extract_flutter/screens/NewCategory/icon_picker_button.dart';
import 'package:extract_flutter/screens/NewCategory/title_text_field.dart';
...
class _NewCategoryScreenState extends State<NewCategoryScreen> {
  ...
  void _insertCategory() async {
    int response = await _categoryRepository.insertCategory(
        Category(_titleController.text.trim(), _selectedColor, _selectedIcon));
